...
pkg=(ansible cronie curl dhclient dhcpcd fabric firefox keepassx hicolor-icon-theme shotwell skype sshfs tmux openvpn vagrant virtualbox wireshark-cli wireshark-gtk xscreensaver yaourt zathura zathura-djvu zathura-pdf-poppler zip)
